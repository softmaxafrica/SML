...
loadCustomerInvoicesDetails(InvoiceNumber: number): void {
  this.dataService.getCustomerInvoiceDetails(this.CustomerId,InvoiceNumber).subscribe(
    (response: any) => {
...
loadPayments(CustomerId: string): void {
  this.dataService.getCustomerPayments(CustomerId).subscribe(
    (response: any) => {
      if (response && response.data) {
...
//#endregion
  ...
  loadCustomerInvoices(CustomerId: string): void {
    this.loadingService.show();
    this.dataService.getCustomerInvoices(CustomerId).subscribe(
      (response: any) => {
        if (response && response.data) {
  ...
  selectedInvoice: any = null;
   ...
   async showInvoiceDetails(invoice: Invoice) {
    ...
    this.loadCustomerInvoicesDetails(invoice.invoiceNumber);
